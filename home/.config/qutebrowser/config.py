...
## Type: Font
c.fonts.monospace = '"Source Code Pro Medium", "DejaVu Sans Mono", Terminus, Monospace, Monaco, "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal'
...
## Type: List of Perc
c.zoom.levels = ['50%', '67%', '75%', '90%', '100%', '120%', '135%', '150%', '175%', '200%']
...
config.bind('U', 'hint links spawn mpv {hint-url}')
